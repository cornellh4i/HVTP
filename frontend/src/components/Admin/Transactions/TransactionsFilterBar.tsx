    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      {appliedFilterChips.map((chip) => (
        <button
          ...
          className="inline-flex h-9 items-center gap-3 rounded-lg bg-[#f3ebd9] px-3 text-sm font-medium text-[#2f2a20] transition-colors hover:bg-[#ece1c8]"
        >
      ...
      <Dialog.Root open={open} onOpenChange={setOpen}>
        <Dialog.Trigger asChild>
          <button
            type="button"
            className="inline-flex h-9 items-center gap-2 rounded-lg px-1 text-sm font-medium text-[#2f391a] transition-colors hover:text-[#556b2f]"
          >
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-[calc(100vw-2rem)] max-w-[530px] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[24px] border border-[#ebe6da] bg-white shadow-[0_20px_60px_rgba(53,51,42,0.18)] outline-none">
            ...
            <div className="flex items-center justify-between border-t border-[#e8e3d8] px-7 py-5">
              <button
                ...
                className="rounded-lg border border-[#70823a] px-4 py-2 text-sm font-medium text-[#556b2f] transition-colors hover:bg-[#f5f8ed]"
              >
                Clear All
              </button>
              <button
                ...
                className="rounded-lg bg-[#556b2f] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#465923]"
              >
                Apply Filters
              </button>
            </div>
